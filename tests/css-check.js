...
const REQUIRED = {
  ...
  request: ['.req-layout', '.tool-bank', '.tool-bench::after', '.tool-bank .tool-pick-opt.is-on::after', '.tool-pick-opt.is-on', '.traveller-mini::before', '.req-errors', '.wz-step.is-done .wz-no', '.wz-dot.is-now', '.lot-line', '.layer-chip.is-on', '.panel-chip.is-scrapped'],
