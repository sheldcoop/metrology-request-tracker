...
| 22 | 2026-09-24, Prince | **Hirata code** in the app | Tool received 2026-09-25; plan in DECISIONS "Hirata code" (H-1: full 9-digit code when known, at least the last 4). Still open: order of the places (form / request page / own page / lots), whether field widths stay fixed (sup 1, year 1, week 2, day 1, lot 2, panel 2) or admin-set, PNG download needed? |
